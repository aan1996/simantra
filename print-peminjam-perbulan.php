...
$pdf->SetTitle('Peminjam Perbulan');
$pdf->SetSubject('Peminjam Perbulan');
$pdf->SetKeywords('Peminjam Perbulan');
...
$pdf->Cell(0, 0.7, 'Laporan Peminjam Perbulan', 0, 0, 'C');
$pdf->ln(10);
$pdf->SetFont('dejavusans', '', 10, '', true);
...
<thead>
      <tr style="text-align: center;">
          ...
          <th colspan="2">Tanggal Pencairan</th>
...
$id = $_GET['id'] ? $_GET['id'] : "";
$result = mysqli_query($con, "SELECT * FROM peminjamperbulan WHERE id='$id'");
$no = 0;
...
// This method has several options, check the source code documentation for more information.
ob_end_clean();
$pdf->Output('peminjam-perbulan.pdf', 'I');
