...
if (isset($_POST['datastruk'])) {
  if (tambahdatastruk($_POST) > 0) {
    echo "<script>
    ...
    window.location.href='tambah-data-struk.php';
    </script>";
  }
}
?>
    ...
    <div class="card">
      ...
      <div class="card-body">
        <form class="form-item" action="" method="post" role="form">
          ...
          <button type="submit" name="datastruk" class="btn btn-primary" onclick="return confirm('Yakin ingin menyimpan?')">Simpan</button>
          <button type="reset" class="btn btn-warning">Clear</button>
          <a href="data-struk.php" class="btn btn-success" onclick="return confirm('Yakin kembali?')">Kembali</a>
        </form>
      </div>
    </div>
  </div>
