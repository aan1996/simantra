...
$pdf->SetTitle('Nasabah Lunas');
$pdf->SetSubject('Nasabah Lunas');
$pdf->SetKeywords('Nasabah Lunas');
...
$result = mysqli_query($con, "SELECT * FROM nasabahlunas");
$no = 0;
...
// This method has several options, check the source code documentation for more information.
ob_end_clean();
$pdf->Output('nasabah-lunas.pdf', 'I');
